...
void ReadFrameData(){
    ...
    for (int ii=1;ii!=4610;ii++){
        ...
        gQueue->saveFrameData(buffer,0,ii-1,bytes_read,(ii-1)*3000);
        fclose(filp);
        usleep(30000);
    }
}
...
int main(int argc, char** argv) {
...

  {
    ...
    sms->addSubsession(LiveStreamServerMediaSubsession
		       ::createNew(*env, streamName, reuseFirstSource,gQueue));
